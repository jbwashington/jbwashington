...
- [webfetch](https://github.com/jbwashington/webfetch) - Fast, stealthy headless browser fetcher for AI agents. Renders JS, returns clean markdown, solves captchas. Built in Rust. 
